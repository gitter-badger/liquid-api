...
//   ------------------------------------------------
//   Hash generated from:
//   sha3_256(voter_id + bill_uid + position + secret)
//
...
module.exports = (req, res) => {
  ...
  // Response is plain text, to format newlines
  ...
  ), `VOTES FOR ${req.params.bill_uid}\n\n\n`)

  // Append info about hash
  .then(verificationString => `${verificationString}
